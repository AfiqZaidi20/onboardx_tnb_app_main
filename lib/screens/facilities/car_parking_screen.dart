      ...
      body: Center(
        child: Column(
          children: [
            ...
            // red box with parking information
            Expanded(
              child: Container(
                ...
                child: ListView(
                  children: const [
                    ...
                    _Parkinginfo(text: 'Zone C (Roadside)\nRM 1.50 for first hour and RM 1.00 for next hour'),
                    _Parkinginfo(text: 'Zone D (Premium)\nRM 6.00 for first hour and RM 3 for next hour'),
